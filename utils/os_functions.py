...
def get_arguments() -> Tuple:
    ...
    :return: A tuple containing the country list, the path for first, personal dataset, and the second path for financial dataset
    :rtype: Tuple
    """
    logger.info(f'Acquiring arguments')
    parser = argparse.ArgumentParser()
    parser.add_argument('--personal', type=str, required=True, help = 'first dataset')
...
def check_file_correct(path_list: str, format: str):
